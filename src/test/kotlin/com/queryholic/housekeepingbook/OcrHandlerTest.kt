...
class OcrHandlerTest(
    ...
    companion object {
        ...
        fun inputAndExpected(): Stream<Arguments> = Stream.of(
                Arguments.of("https://user-images.githubusercontent.com/10183131/103668956-1b464200-4fbb-11eb-9083-622ceccc4e4e.png", "/합계:49,220")
                , Arguments.of("https://user-images.githubusercontent.com/10183131/104035815-eaae1480-5215-11eb-9a00-253d3bc6c912.png", "합계:33,760")
        )
    }
